...
const spacers = {
  'コンポーネント内部 小 p-1 m-1 gap-1': tw`w-1 h-1`,
  'コンポーネント内部 大 p-2 m-2 gap-2': tw`w-2 h-2`,
  'コンポーネント間 小 p-3 m-3 gap-3': tw`w-3 h-3`,
  'コンポーネント間 大 p-4 m-4 gap-4': tw`w-4 h-4`,
  'コンポーネント包含 小 p-6 m-6 gap-6': tw`w-6 h-6`,
  'コンポーネント包含 大 p-8 m-8 gap-8': tw`w-8 h-8`,
}
