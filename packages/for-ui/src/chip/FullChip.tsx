...
export const FullChip: FC<Omit<ChipProps, 'clickableArea'>> = ({
  ...
  <button
    onClick={onClick}
    className={fsx([
      `shadow-attractive focus-visible:shadow-focused inline-flex w-min flex-row items-center justify-center gap-1 break-keep rounded px-2 outline outline-1 -outline-offset-1`,
      {
