...
const _Button = <As extends ElementType = 'button'>({
  ...
  return (
    <MuiButton<As>
      ...
      aria-busy={loading}
      className={fsx([
        `rounded-1.5 focus-visible:shadow-focus relative flex h-fit w-fit shrink-0 flex-row items-center justify-center font-sans outline-none disabled:cursor-not-allowed [&_svg]:fill-inherit`,
        {
          text: {
