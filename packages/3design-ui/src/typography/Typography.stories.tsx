...
`,
    ...
    page: () => (
      <Fragment>
        ...
        <Description
          markdown={`
four-uiでは5サイズのTypographyを使い分けています。
...
Colors.parameters = {
  ...
  docs: {
    source: {
      language: 'tsx',
      code: `
import { Text } from '@4design/four-ui'
...
import { Text, variants } from '@4design/four-ui'
...
またinput内などでコンポーネントを使えないときのため，styleのみのexportもされています。\`import { typographyStyles } from '@4design/four-ui'\` で使うことができます
        `}
        />
        <Source />
